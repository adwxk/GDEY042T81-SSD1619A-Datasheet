...
在淘宝**鑫盛液晶**买了一块 4.2 寸黑白墨水屏，型号 FPC-194。

商家没有提供任何技术资料。用 SSD1683 的标准驱动不能实现局刷，折腾了很久才发现实际控制器是 **SSD1619A**，和 SSD1683 命令集兼容但 LUT 格式完全不同。

感谢评论区大哥分享了关键信息（ic是SSD1619A，70 字节 LUT、0xC5 mode byte），才终于点亮。在此基础上用 AI 辅助整理了完整的驱动文档，包含裸 SPI 驱动代码、GxEPD2 集成、LUT 调参指南等。
